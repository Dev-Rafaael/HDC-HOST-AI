import { IPlans } from "../../../Plans/domain/interface/IPlans";
import { PlansDTO } from "../../../Plans/dtos/PlansDTO";
...
export class SuggestPlanUseCase {
  constructor(
    ...
    private plansRepository: IPlans,
  ) {}

  private formatPlans(plans: PlansDTO[]) {
    return plans
      .map((plan) => {
